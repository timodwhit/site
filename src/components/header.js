...
const Header = ({ siteTitle }) => (
  <header id="site-header">
    <div id="logo">
      <Link to="/">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1594.31 566.62"><defs></defs>
          <g id="logo" data-name="Logo with Name">
            <rect class="logo--primary" x="43.34" y="40" width="550" height="495.78"/>
            <g id="logo-square">
              <polygon class="logo--secondary" points="503.38 48.45 563.38 48.45 383.38 518.45 323.38 518.45 503.38 48.45"/>
              <path class="logo--secondary" d="M155,85.74V216.92l51.3.7L221.21,257l-66.2.86V417.28c0,36.65,10.39,57.42,40.32,57.42,5,0,9.57-.24,13.65-.62L372.57,48.7l60.13-.12-180,469.85-45.39,0s-22.3.29-26,.29c-25.05,0-45.21-7.94-58-22.6-15.27-15.88-20.77-42.15-20.77-77V257.84H56.66V216.92h45.82L101.21,85.74Z"/>
            </g>
            <g id="logo-name">
